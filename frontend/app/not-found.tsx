...
export default function NotFound() {
  return (
    <main className="grid min-h-screen place-items-center px-4 pb-8 pt-20">
      <div className="max-w-lg text-center">
        <p className="text-xs font-bold uppercase tracking-[0.24em] text-emerald-400">404 · Event not found</p>
        <h1 className="mt-4 text-3xl font-semibold text-white sm:text-4xl">This event is not in the archive.</h1>
