...
export interface AiRouterDecision {
  ...
  needsGeneralExplanation: boolean;
...
export const AI_ROUTER_JSON_SCHEMA = {
  ...
  required: ["route", "language", "generalTopic", "databaseIntent", "needsHistoricalAnalysis", "needsGeneralExplanation", "clarificationQuestion", "refusalReason"],
  properties: {
    ...
    needsGeneralExplanation: { type: "boolean" },
...
export function validateRouterDecision(input: unknown): AiRouterDecision {
  ...
  const exactKeys = ["route", "language", "generalTopic", "databaseIntent", "needsHistoricalAnalysis", "needsGeneralExplanation", "clarificationQuestion", "refusalReason"];
  ...
  if (typeof value.needsHistoricalAnalysis !== "boolean" || typeof value.needsGeneralExplanation !== "boolean") throw new Error("Invalid route flags.");
  ...
  if (value.needsHistoricalAnalysis !== historical || value.needsGeneralExplanation !== general) throw new Error("Inconsistent route flags.");
