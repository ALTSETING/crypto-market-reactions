...
export const AI_SEARCH_FIXTURES: readonly AnalyticsEvent[] = [
  fixture({ eventId: "evt-ai-001", slug: "sec-approves-spot-ether-etfs", title: "SEC approves spot Ether ETFs", publishedAt: "2024-05-23T21:00:00Z", assets: ["ETH", "BTC"], category: "regulation", sourceClass: "primary_document", sentiment: "positive", importance: "high" }, { ETH: { "1h": 2.4, "4h": 4.1, "24h": 6.2 }, BTC: { "4h": 1.1 } }),
  fixture({ eventId: "evt-ai-002", slug: "sec-delays-ether-etf-decision", title: "SEC delays Ether ETF decision", publishedAt: "2024-01-25T15:30:00Z", assets: ["ETH"], category: "regulation", sourceClass: "primary_document", sentiment: "negative", importance: "medium" }, { ETH: { "1h": -1.2, "4h": -2.5, "24h": -3.4 } }),
